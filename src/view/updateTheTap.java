 ...
 * @author locmi
 */
public class updateTheTap extends javax.swing.JFrame {
    private TheTapForm panel;
    private TheTap ttap;
    /**
     * Creates new form updateTheTap
     */
    public updateTheTap(TheTapForm panel, TheTap ttap) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CẬP NHẬT THẺ TẬP");
    ...
    private void bt_ThemMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_bt_ThemMouseClicked
        ...
        try {
            TheTapDAO.getInstance().update(ttap);
            ...
            else if (errorMessage.contains("Gói tập không hợp lệ.")) {
                JOptionPane.showMessageDialog(this, "Gói tập không hợp lệ.", "Lỗi", JOptionPane.ERROR_MESSAGE);
            }
            else {
