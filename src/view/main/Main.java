...
//        jScrollPane1.setViewportBorder(null);
    ...
    private void initComponents() {
        ...
        SignIn.setBackground(new java.awt.Color(243, 197, 192));
        ...
        txtUser.setLineColor(new java.awt.Color(243, 197, 192));
        txtUser.setSelectionColor(new java.awt.Color(243, 197, 192));
        ...
        txtPass.setLineColor(new java.awt.Color(243, 197, 192));
        txtPass.setSelectionColor(new java.awt.Color(243, 197, 192));
...
//        if (!animatorLogin.isRunning()) {
            ...
            if (pass.equals("")) {
                txtPass.setHelperText("Please enter password");
                if (action) {
                    txtPass.grabFocus();
                }
                action = false;
